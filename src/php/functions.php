...
function wordpressify_resources() {
	...
	// wp_enqueue_script( 'header_js', get_template_directory_uri() . '/scripts/header-bundle.js', null, 1.0, false );
	wp_enqueue_script( 'footer_js', get_template_directory_uri() . '/scripts/scripts.js', null, 1.0, true );
}
